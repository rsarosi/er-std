...
**
** Created: Mon May 24 15:55:04 2010
...
static const char qt_meta_stringdata_ControllerWidget[] = {
    "ControllerWidget\0"
};

const QMetaObject ControllerWidget::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ControllerWidget,
      qt_meta_data_ControllerWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ControllerWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ControllerWidget))
